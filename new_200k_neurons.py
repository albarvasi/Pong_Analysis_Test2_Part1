...
f = open("Albar_C0854302_200KNeurons.csv", "w")
writer = csv.writer(f)
header = ["Neurons","Learning Rate","Episode Number","CPU in %", "Ram", "Start Time", "End Time", "Execution Time","Running Mean"]
...
def train_model(env, model, total_episodes = 100):
  ...
  while True:
    ...
    if done: # an episode finished
      ...
      print('Total Memory:', memoryUse)
      # print("Start Time:", datetime_start_time)
      # print("End Time:", datetime_end_time)
      print(f"DateTime Execution Time: {datetime_execution_time}")
      ...
      # f = open("Test_Albar_2.txt", "a")
      # f.write(str(running_reward))
      data = ["200000","1e-4",episode_number, CPU_core_usage, psutil.virtual_memory()[2],datetime_start_time,datetime_end_time,datetime_execution_time,running_reward]
...
H = 200000 # number of hidden layer neurons
