...
f = open("Albar_C0854302_10000Neurons.csv", "w")
writer = csv.writer(f)
...
def train_model(env, model, total_episodes = 100):
  ...
  while True:
    ...
    if done: # an episode finished
      ...
      data = ["10000","1e-4",episode_number, CPU_core_usage, psutil.virtual_memory()[2],datetime_start_time,datetime_end_time,datetime_execution_time,running_reward]
...
H = 10000 # number of hidden layer neurons
