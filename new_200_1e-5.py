...
f = open("Albar_C0854302_200Neurons_LearningRate1e-5.csv", "w")
writer = csv.writer(f)
...
def train_model(env, model, total_episodes = 100):
  ...
  while True:
    ...
    if done: # an episode finished
      ...
      data = ["200","1e-5",episode_number, CPU_core_usage, psutil.virtual_memory()[2],datetime_start_time,datetime_end_time,datetime_execution_time,running_reward]
