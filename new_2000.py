...
f = open("Albar_C0854302_2000Neurons.csv", "w")
writer = csv.writer(f)
header = ["Neurons","Episode Number","CPU in %", "Ram", "Start Time", "End Time", "Execution Time","Running Mean"]
...
def train_model(env, model, total_episodes = 100):
  ...
  while True:
    ...
    if done: # an episode finished
      ...
      data = ["2000",episode_number, CPU_core_usage, psutil.virtual_memory()[2],datetime_start_time,datetime_end_time,datetime_execution_time,running_reward]
